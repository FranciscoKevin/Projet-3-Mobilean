 ...
 */
final class Version20201216093039 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE vehicle (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) DEFAULT NULL, description LONGTEXT DEFAULT NULL, type VARCHAR(50) DEFAULT NULL, fiscal_power INT DEFAULT NULL, actual_power INT DEFAULT NULL, tank_capacity_cng INT DEFAULT NULL, consumption_cng INT DEFAULT NULL, tank_capacity_fuel INT DEFAULT NULL, consumption_fuel INT DEFAULT NULL, autonomy INT DEFAULT NULL, rear_compartment_volume INT DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
